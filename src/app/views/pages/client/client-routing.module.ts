...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: { title: 'Client Reservations' }
      },
      {
        path: 'dashboard',
        loadComponent: () =>
      ...
      },
      {
        path: 'categories',
        loadComponent: () =>
          import('src/app/components/client/client-categories/client-categories.component')
            .then(m => m.ClientCategoriesComponent),
        data: { title: 'Client Categories' }
      }
